...
import hexlet.code.exception.UnknowOperationException;
...
public record Calc() {
    ...
    public static void run() throws UnknowOperationException {
        Engine.run(
                RULES,
    ...
    private static String[] nextRound() throws UnknowOperationException {
    ...
    private static String makeCorrectAnswer(int firstOperand, char operation, int secondOperand)
        ...
        return switch (operation) {
            ...
            case '-' -> String.valueOf(firstOperand - secondOperand);
            case '*' -> String.valueOf(firstOperand * secondOperand);
            default -> throw new UnknowOperationException("Unknown operation: %s!".formatted(operation));
        };
    }
}
